...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/order/status/{orderID}/{status}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/user/cart/checkout": {
            "post": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error - Failed to checkout",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/user/cart/{product_id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Product removed/decreased from cart successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "domain.Product": {
            ...
            "properties": {
                ...
                "created_at": {
                    "description": "IsActive    bool           ` + "`" + `json:\"is_active\" gorm:\"default:true\"` + "`" + `",
                    "type": "string"
                },
                "description": {
                    "type": "string"
